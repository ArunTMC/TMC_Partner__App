...
public class Adapter_TomorrowsDeliverySlots extends ArrayAdapter<Modal_DeliverySlots> {
    Context mContext;

    List<Modal_DeliverySlots> slotlist;
    ChangeDelivery_Slot_Availability_Status changeDelivery_slot_availability_status;
    public Adapter_TomorrowsDeliverySlots(Context mContext, List<Modal_DeliverySlots> slotlist, ChangeDelivery_Slot_Availability_Status changeDelivery_slot_availability_status) {
