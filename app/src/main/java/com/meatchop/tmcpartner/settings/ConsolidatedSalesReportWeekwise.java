...
public class ConsolidatedSalesReportWeekwise extends AppCompatActivity {
    LinearLayout generateSubCtgyReport_Layout , storename_totalSale_layout, fetchData,endDateSelectorLayout,generateReport_Layout, dateSelectorLayout, loadingpanelmask, loadingPanel;
    ...
    private static String[] columns_SubCtgyReport = {"S.No","SubCtgy Name  ","Weight / Pc ","Price"};
    ...
    */
        ...
        totalCreditMarkupPercentageValue =0;
                   ...
                   /* if(vendorKey.equals("vendor_5")){
                        ...
                        Call_andGetValueFromTMCTestTable(fromDateAsnewFormat, toDateAsnewFormat, vendorKey);
 ...
 */
            ...
            public void onClick(View view) {
                ...
                if(SubCtgywiseTotalArray.size()>0){
                    ...
                    if (SDK_INT >= Build.VERSION_CODES.R) {
                        ...
                        if(Environment.isExternalStorageManager()){
                            try {
                                AddDatatoSubCtgyWiseExcelSheet(Order_Item_List);
        ...
        try {
            if (processToDo.equals("FetchTMCMenuItem")) {
                if (tmcMenuItemSQL_db_manager == null) {
                    tmcMenuItemSQL_db_manager = new TMCMenuItemSQL_DB_Manager(ConsolidatedSalesReportWeekwise.this);
                    try {
                ...
                try {
                    ...
                    try {
                        ...
                        if (cursor.getCount() > 0) {
                            ...
                            Toast.makeText(ConsolidatedSalesReportWeekwise.this, "There is no menuItem Please Refresh the App", Toast.LENGTH_SHORT).show();
    ...
    private void processArrayAndgetData(List<Modal_ManageOrders_Pojo_Class> orderslist_fromResponse) {
        ...
        for (int i = 0; i < orderslist_fromResponse.size(); i++) {
            ...
            Modal_OrderDetails modal_orderDetails = new Modal_OrderDetails();
            ordertype_forDebug = orders_pojo_class_fromResponse.getOrdertype().toString().toUpperCase();
            try {
            ...
            if(ordertype_forDebug.equals(Constants.APPORDER)) {
            ...
            try {
                ...
                if ((ordertype.equals(Constants.APPORDER))) {
                    ...
                    try {
                        CreditOrder_CouponDiscount = CouponDiscount;
 ...
 */
    ...
    private void AddDatatoSubCtgyWiseExcelSheet(List<String> order_item_list) {
        ...
        for (int i = 0; i < columns_SubCtgyReport.length; i++) {
            headercell = headerRow.createCell(i);
            headercell.setCellValue(columns_SubCtgyReport[i]);
        ...
        for (String SubCtgykey : tmcSubCtgykey) {
            ...
            try {
                ...
                try{
                    ...
                    row.createCell(1).setCellValue(SubCtgyName );
                ...
                if(SubCtgykey.equals("Miscellaneous") || subCtgyWeightdouble <=0 ) {
                    row.createCell(2).setCellValue(subCtgyQty );
                }
                else{
                    row.createCell(2).setCellValue(subCtgyWeight );
                }

                row.createCell(3).setCellValue(subCtgyTotal );
    ...
    private void GenerateSubCtgyWiseExcelSheet() {
        String  path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/TMCPartner/Consolidated SubCtgy Report Weekwise/";
        ...
        File file = new File(dir, "Consolidated SubCtgy Report "+ System.currentTimeMillis()  +".xls");
