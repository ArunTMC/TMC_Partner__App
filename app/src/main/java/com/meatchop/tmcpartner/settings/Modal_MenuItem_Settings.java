...
public class Modal_MenuItem_Settings extends Throwable {
    ...
    String localDB_id = "0",tmcpriceWithMarkupValue ="0",tmcpriceperkgWithMarkupValue ="0",appmarkuppercentage,menuItemKeyFromInventoryDetails="",itemnameFromInventoryDetails ="",relationtypeFromInventoryDetails ="CHILD";
    ...
    public boolean isMarinadeItem() {
        return isMarinadeItem;
    }

    public void setMarinadeItem(boolean marinadeItem) {
        isMarinadeItem = marinadeItem;
    }

    public String getMarinadeKey() {
        return marinadeKey;
    }

    public void setMarinadeKey(String marinadeKey) {
        this.marinadeKey = marinadeKey;
    }

    public boolean getisMarinadeItem() {
        return isMarinadeItem;
    }

    public void setIsMarinadeItem(boolean marinadeItem) {
        isMarinadeItem = marinadeItem;
    }

    public String getMarinadeItemAvailability() {
        return marinadeItemAvailability;
    }

    public void setMarinadeItemAvailability(String marinadeItemAvailability) {
        this.marinadeItemAvailability = marinadeItemAvailability;
    }

    public String getMarinadeBarcode() {
        return marinadeBarcode;
    }

    public void setMarinadeBarcode(String marinadeBarcode) {
        this.marinadeBarcode = marinadeBarcode;
    }

    public String getMarinadeItemUniqueCode() {
        return marinadeItemUniqueCode;
    }

    public void setMarinadeItemUniqueCode(String marinadeItemUniqueCode) {
        this.marinadeItemUniqueCode = marinadeItemUniqueCode;
    }
