    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        menuItem_CardLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Modal_NewOrderItems modal_newOrderItems = new Modal_NewOrderItems();
                if (Double.parseDouble(menuuItem.getSwiggyprice()) <= 0) {
                    Toast.makeText(context, "Please Add Swiggy Price value for this item before billing it ", Toast.LENGTH_SHORT).show();
                } else {
