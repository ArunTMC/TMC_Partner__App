...
public class AddSwiggyOrders extends AppCompatActivity {
    ...
    static Adapter_AddSwiggyOrdersRecyclerview adapter_addSwiggyOrdersRecyclerview;
    ...
    EditText swiggyOrdersCustomermobileno;
    ...
    private static final String ACTION_USB_PERMISSION = "com.android.example.USB_PERMISSION.AddSwiggyOrders";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        procced_to_pay_widget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (swiggyOrdersCustomermobileno.getText().toString().length() == 10) {
                    ...
                    if ((!total_item_Rs_text_widget.getText().toString().equals("0")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals("0")) &&(!total_item_Rs_text_widget.getText().toString().equals("0.0")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals("0.0"))&&(!total_item_Rs_text_widget.getText().toString().equals("0.00")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals("0.00"))&&(!total_item_Rs_text_widget.getText().toString().equals("")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals(""))) {
                        ...
                        PlaceOrdersinDatabaseaAndPrintRecipt(Constants.SWIGGYORDER_PAYMENTMODE, sTime, Currenttime, cart_Item_List);
                            ...
                            AlertDialogClass.showDialog(AddSwiggyOrders.this, R.string.Orders_weight_Cant_be_leave_unedited);
                        ...
                        AlertDialogClass.showDialog(AddSwiggyOrders.this, R.string.Cant_place_order);

                    }
                } else {
                    AlertDialogClass.showDialog(AddSwiggyOrders.this, R.string.Cart_is_empty);

                }

            } else {
                AlertDialogClass.showDialog(AddSwiggyOrders.this, R.string.Enter_the_mobile_no_text);
    ...
    void CallAdapter() {
        ...
        //  adapter_cartItem_listview= new Adapter_CartItem_Listview(AddSwiggyOrders.this,cartItem_hashmap, MenuItems,AddSwiggyOrders.this);
        //  listview.setAdapter(adapter_cartItem_listview);
        adapter_addSwiggyOrdersRecyclerview = new Adapter_AddSwiggyOrdersRecyclerview(getApplicationContext(),cartItem_hashmap, MenuItem, AddSwiggyOrders.this);
        adapter_addSwiggyOrdersRecyclerview.setHandler(newHandler());
        recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        int last_index=AddSwiggyOrders.cartItem_hashmap.size()-1;

        recyclerView.setAdapter(adapter_addSwiggyOrdersRecyclerview);
    ...
    private void PlaceOrdersinDatabaseaAndPrintRecipt(String paymentMode, long sTime, String currenttime, List<String> cart_Item_list) {
        ...
        if (ispaymentMode_Clicked) {
            ...
            if (!isOrderDetailsMethodCalled) {
                ...
                PlaceOrder_in_OrderDetails(AddSwiggyOrders.cart_Item_List, paymentMode, sTime);
            }
    ...
    private void PlaceOrder_in_OrderDetails(List<String> cart_Item_List1, String Payment_mode, long sTime) {
        ...
        String tokenno = "";
        String userid = "";
       String ordertype = Constants.SwiggyOrder;
                        ...
                        try {
                            if(printerType_sharedPreference.equals(Constants.USB_PrinterType)){
                                ...
                                if(i != -1){
                                    ...
                                    new TMCAlertDialogClass(AddSwiggyOrders.this, R.string.app_name, R.string.OrderPlaced_Printer_is_Disconnected,
                                            R.string.OK_Text,R.string.Empty_Text,
                                            new TMCAlertDialogClass.AlertListener() {
                                                @Override
                                                public void onYes() {
                                                    AddSwiggyOrders. cart_Item_List.clear();
                                                    AddSwiggyOrders.cartItem_hashmap.clear();
                                                    cart_Item_List.clear();
                                                    cartItem_hashmap.clear();
                                                    StockBalanceChangedForThisItemList.clear();
                                                    new_to_pay_Amount =0;
                                ...
                                new TMCAlertDialogClass(AddSwiggyOrders.this, R.string.app_name, R.string.OrderPlaced_Printer_is_Disconnected,
                                        ...
                                        new TMCAlertDialogClass.AlertListener() {
                                            ...
                                            public void onYes() {
                                                ...
                                                finalamounttoPay=0;
                                                showProgressBar(false);
                                                //Toast.makeText(AddSwiggyOrders.this,"Please Generate Token Number Again",Toast.LENGTH_SHORT).show();
                                            }
    ...
    private void PrintReciptForNewItemUsingUSBPrinter(String userMobile, String tokenno, String itemTotalwithoutGst, String taxAmount, String payableAmount, String orderid, List<String> cart_item_list, HashMap<String, Modal_NewOrderItems> cartItem_hashmap, String payment_mode, String finalCouponDiscountAmount, String ordertype) {
        ...
        UsbConnection usbConnection = UsbPrintersConnectionsLocal.selectFirstConnected(AddSwiggyOrders.this);
        UsbManager usbManager = (UsbManager) AddSwiggyOrders.this.getSystemService(Context.USB_SERVICE);
        ...
        if (usbConnection == null || usbManager == null) {
           ...
           */
            ...
            new TMCAlertDialogClass(AddSwiggyOrders.this, R.string.app_name, R.string.ReConnect_Instruction,
    ...
    private final BroadcastReceiver usbReceiver_newItem = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_USB_PERMISSION.equals(action)) {
                synchronized (AddSwiggyOrders.this) {
                    UsbManager usbManager = (UsbManager) AddSwiggyOrders.this.getSystemService(Context.USB_SERVICE);
                            ...
                            new AsyncUsbEscPosPrint(
                                ...
                                public void onSuccess(AsyncEscPosPrinter asyncEscPosPrinter) {
                                    ...
                                    if (!isPrintedSecondTime) {
                                        ...
                                        new TMCAlertDialogClass(AddSwiggyOrders.this, R.string.app_name, R.string.RePrint_Instruction,
 ...
 */
           // text_to_Print = text_to_Print + "[L]" + payableAmount + " \n";
            ...
            Toast.makeText(AddSwiggyOrders.this, "Size of Cart is not matched", Toast.LENGTH_SHORT).show();
        }
      ...
      */
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.api_getListofStockOutGoingDetailsForStockIncmgKey + stockIncomingKey_avlDetails, null,
                        ...
                        public void onErrorResponse(@NonNull VolleyError error) {
                            ...
                            Toast.makeText(AddSwiggyOrders.this, "Error in General App Data code :  " + errorCode, Toast.LENGTH_LONG).show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.api_addEntry_StockTransactionHistory
            ...
            public void onResponse(@NonNull JSONObject response) {
                ...
                try {
                    ...
                    // showProgressBar(false);
                    Toast.makeText(AddSwiggyOrders.this,"Failed to Add Data in Stock Outgoing table",Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
        ...
        if(changeItemAvailability){
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.api_updateMenuItemDetails,
                ...
                public void onErrorResponse(@NonNull VolleyError error) {
                    ...
                    //Log.d(Constants.TAG, "Error: " + error.toString());
                    showProgressBar(false);
                    Toast.makeText(AddSwiggyOrders.this,"Failed to change express delivery slot status inDelivery slot details",Toast.LENGTH_LONG).show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, api_Update_MenuItemStockAvlDetails
            ...
            public void onResponse(@NonNull JSONObject response) {
                ...
                try {
                    ...
                    // showProgressBar(false);
                    Toast.makeText(AddSwiggyOrders.this,"Failed to change express delivery slot status in Delivery slots",Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
