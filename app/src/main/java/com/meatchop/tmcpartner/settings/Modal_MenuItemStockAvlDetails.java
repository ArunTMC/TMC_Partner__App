...
public class Modal_MenuItemStockAvlDetails {

    public  String barcode,itemavailability,key,lastupdatedtime,menuitemkey,stockbalance,stockincomingkey,vendorkey,allownegativestock,receivedstock;
