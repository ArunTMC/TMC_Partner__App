...
public class MyAsyncTaskForPrintingReceipt extends AsyncTask<Void, Void, String> {
   ...
   public MyAsyncTaskForPrintingReceipt(Context context, AsyncTaskListener_forPrintReceipt listener, String userMobile, String itemTotalwithoutGst, String taxAmount, String payableAmount, String orderid, String payment_mode, String discountAmount_StringGlobal, String ordertype, String orderplacedTime, List<String> cart_Item_List, HashMap<String, Modal_NewOrderItems> cartItem_hashmap, String vendorKey) {
        mContext = context;
        mListener = listener;
    ...
    public MyAsyncTaskForPrintingReceipt(Context mContext, AsyncTaskListener_forPrintReceipt callBackAsyncTaskListener_forPrintReceipt, Modal_forPrintReceipt modal_forPrintReceipt, BroadcastReceiver myReceiverforPrintingServicee) {
        mContext = mContext;
        ...
        this.myReceiverforPrintingService =myReceiverforPrintingServicee;
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        // Do any setup before starting the background task
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        // For example, let's say we want to download an image from a URL
        try {
            ...
            IntentFilter filter = new IntentFilter("receiveDataFromprinterService");
