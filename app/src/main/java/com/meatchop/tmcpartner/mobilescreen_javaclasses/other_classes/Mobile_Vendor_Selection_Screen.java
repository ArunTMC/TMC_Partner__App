...
public class Mobile_Vendor_Selection_Screen extends AppCompatActivity implements Spinner.OnItemSelectedListener {
    ...
    private  Boolean inventoryCheckBool = false , localDBcheck = false ,istestvendor =false;
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
            ...
            public void onComplete(@NonNull Task<InstanceIdResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Mobile_Vendor_Selection_Screen.this, "token  :  "+newtoken, Toast.LENGTH_SHORT).show();
                }
