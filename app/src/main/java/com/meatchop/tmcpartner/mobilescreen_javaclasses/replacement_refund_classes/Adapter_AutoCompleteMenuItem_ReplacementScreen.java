...
public class Adapter_AutoCompleteMenuItem_ReplacementScreen extends ArrayAdapter<Modal_NewOrderItems> {
    ...
    public Adapter_AutoCompleteMenuItem_ReplacementScreen(@NonNull Context context, @NonNull String menuList, int adapterPosition, String ordertype_Oldd, AddReplacement_Refund_OrdersScreen addReplacement_refund_ordersScreen, List<Modal_NewOrderItems> menuItemArray, boolean localDBCheck) {
        super(context, 0);
        this.menulist=menuList;
        this.localDBCheck= localDBCheck;
        if(localDBCheck){
            this.menuListFull = menuItemArray;
        }
        else{
