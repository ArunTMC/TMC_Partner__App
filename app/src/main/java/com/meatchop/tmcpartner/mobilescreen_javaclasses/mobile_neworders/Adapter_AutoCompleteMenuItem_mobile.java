...
public class Adapter_AutoCompleteMenuItem_mobile extends ArrayAdapter<Modal_NewOrderItems> {
    ...
    int currentPosition;
        ...
        public Adapter_AutoCompleteMenuItem_mobile(@NonNull Context context, @NonNull String menuList, int adapterPosition, List<Modal_NewOrderItems> completemenuItem) {
            super(context, 0);
            this.menulist=menuList;
            //convertMenuStringtoJson(menulist);
            this.menuListFull = completemenuItem;
