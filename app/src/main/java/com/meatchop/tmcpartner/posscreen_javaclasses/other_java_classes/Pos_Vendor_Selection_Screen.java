...
import com.meatchop.tmcpartner.mobilescreen_javaclasses.other_classes.Mobile_LoginScreen;
...
public class Pos_Vendor_Selection_Screen extends AppCompatActivity  {
    ...
    private  Boolean inventoryCheckBool = false ,isweighteditable = false , localDBcheck = false,isweightmachineconnected = false;
    double screenInches;
    String newtoken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
                ...
                public void onComplete(@NonNull Task<InstanceIdResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Pos_Vendor_Selection_Screen.this, "token  :  " + newtoken, Toast.LENGTH_SHORT).show();
                    }
        ...
        pos_vendor_selecting_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                try {
                    localDBcheck = Boolean.parseBoolean(getVendorData(position, "localdbcheck"));
                }
                catch (Exception e){
                    e.printStackTrace();
                }
                ...
                try{
                    isweightmachineconnected =      Boolean.parseBoolean(getVendorData(position, "isweightmachineconnected"));
    ...
    private void connectSQLAndRemoveTables() {
        ...
        myEdit.apply();
        try{
            vendorSQL_db_manager.dropTable(false);
            posAppMobileDataSQL_db_manager.dropTable(false);
            tmcMenuItemSQL_db_manager.dropTable(false);
        }
        catch (Exception e){
            e.printStackTrace();
        }
...
///////////////////////////////////
                                        ...
                                        try {
                                            ...
                                            if(json.has("localdbcheck")){
                                                modal_vendor.setLocaldbcheck( String.valueOf(json.get("localdbcheck")));


                                            }
                                            else{
                                                modal_vendor.setLocaldbcheck( String.valueOf(""));
