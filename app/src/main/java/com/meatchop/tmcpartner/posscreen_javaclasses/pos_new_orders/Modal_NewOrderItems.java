...
public class Modal_NewOrderItems extends Throwable implements Serializable {
   ...
   , localDB_id ,tmcsubctgykey,gstpercentage,tmcctgykey,itemuniquecode,tmcprice,categoryname,totalGstAmount,total_pricePerItem,total_of_subTotal_perItem,barcode,
