...
public class Adapter_AssignDeliveryPartner extends ArrayAdapter<AssignDeliveryPartner_PojoClass>{
  Context mContext;
    ...
    public Adapter_AssignDeliveryPartner(Context mContext, List<AssignDeliveryPartner_PojoClass> deliveryPartnerList, String orderKey) {
                            ...
                            try {
                                ...
                                if(msg.equals("success")){
                                  ...
                                  */
                                    ...
                                    Intent i = new Intent(mContext, Pos_Dashboard_Screen.class);
