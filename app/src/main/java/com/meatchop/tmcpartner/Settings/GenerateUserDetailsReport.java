...
public class GenerateUserDetailsReport extends AppCompatActivity {
   ...
   ListView userCount_listview;
    ...
    private void getUserDetailsUsingDate(String createdTime, String vendorKey, String todatestring, boolean isDatewise) {
        ...
        try {
            if (isDatewise) {
                api = Constants.api_getListofUsersForCreatedTime + createdTime;
            } else {
                        ...
                        try {
                            ...
                            for(;i1<=(arrayLength-1);i1++) {
                                ...
                                try {
                                    ...
                                    try{
                                        if(json.has("key")){
                                            modal_user.setKey(String.valueOf(json.get("key")));
                                        }
                                        else{
