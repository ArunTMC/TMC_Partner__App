...
public class Adapter_AutoCompleteMenuitemForWholeSaleOrders extends ArrayAdapter<Modal_NewOrderItems> {
    List<Modal_MenuItem_Settings>Menulist = new ArrayList<>();;
    private  List<Modal_NewOrderItems> menuListFull=new ArrayList<>();
    private Context context;
    private Handler handler;
    int currentPosition;
    public Adapter_AutoCompleteMenuitemForWholeSaleOrders(@NonNull Context context, @NonNull List<Modal_MenuItem_Settings> menuList, int adapterPosition) {
        super(context, 0);
    ...
    private void AddDatatoMenulistfull() {
        for(int i =0; i<Menulist.size();i++){
            ...
            modal_newOrderItems.wholesaleprice = modal_menuItem_settings.getWholesaleprice();
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        menuItem_CardLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Modal_NewOrderItems modal_newOrderItems = new Modal_NewOrderItems();
                if (Double.parseDouble(menuuItem.getWholesaleprice()) <= 0) {
                    Toast.makeText(context, "Please Add Whole Sale Price value for this item before billing it ", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    modal_newOrderItems.itemFinalPrice = (String.valueOf(decimalFormat.format(Double.parseDouble(menuuItem.getWholesaleprice()))));
                    modal_newOrderItems.itemPrice_quantityBased = (String.valueOf(decimalFormat.format(Double.parseDouble(menuuItem.getWholesaleprice()))));
                    ...
                    if (String.valueOf(menuuItem.getPricetypeforpos()).equals("tmcpriceperkg")) {
                        int priceperKg = Integer.parseInt(menuuItem.getWholesaleprice());
                        ...
                        if (weight > 1000) {
                            priceperKg = Integer.parseInt(menuuItem.getWholesaleprice());
                    ...
                    try {
                        modal_newOrderItems.setWholesaleprice(String.valueOf(menuuItem.getWholesaleprice()));
                    ...
                    //   int last_index =  (AddWholeSalesOrder.cart_Item_List.size()-1);
                    //  AddWholeSalesOrder.cart_Item_List.set(last_index,modal_newOrderItems);
                    //    AddWholeSalesOrder.adapter_cartItem_recyclerview.notifyDataSetChanged();
    ...
    private void addItemIntheCart(Modal_NewOrderItems newItem_newOrdersPojoClass, String itemWeight,String itemUniquecode) {
        ...
        if(IsItemAlreadyAddedinCart){
            Modal_NewOrderItems modal_newOrderItems = AddWholeSalesOrder.cartItem_hashmap.get(itemUniquecode);
            ...
            AddWholeSalesOrder.cartItem_hashmap.put(itemUniquecode,modal_newOrderItems);
            ...
            AddWholeSalesOrder.cart_Item_List.add(itemUniquecode);
            AddWholeSalesOrder.cartItem_hashmap.put(itemUniquecode,newItem_newOrdersPojoClass);
