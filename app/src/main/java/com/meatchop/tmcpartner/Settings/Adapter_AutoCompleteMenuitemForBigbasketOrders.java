...
public class Adapter_AutoCompleteMenuitemForBigbasketOrders  extends ArrayAdapter<Modal_NewOrderItems> {
    ...
    public Adapter_AutoCompleteMenuitemForBigbasketOrders(@NonNull Context context, @NonNull List<Modal_MenuItem_Settings> menuList, int adapterPosition) {
        super(context, 0);
    ...
    private void AddDatatoMenulistfull() {
        for (int i = 0; i < Menulist.size(); i++) {
            ...
            modal_newOrderItems.bigbasketAmount = modal_menuItem_settings.getBigbasketprice();
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        menuItem_CardLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                modal_newOrderItems.itemFinalPrice = (String.valueOf(decimalFormat.format(Double.parseDouble(menuuItem.getBigbasketAmount()))));
                modal_newOrderItems.itemPrice_quantityBased = (String.valueOf(decimalFormat.format(Double.parseDouble(menuuItem.getBigbasketAmount()))));
                ...
                if (String.valueOf(menuuItem.getPricetypeforpos()).equals("tmcpriceperkg")) {
                    int priceperKg = Integer.parseInt(menuuItem.getBigbasketAmount());
                    ...
                    if (weight > 1000) {
                        priceperKg = Integer.parseInt(menuuItem.getBigbasketAmount());
                ...
                try {
                    modal_newOrderItems.setBigbasketAmount(String.valueOf(menuuItem.getBigbasketAmount()));

                } catch (Exception e) {
                    //    Toast.makeText(context,"Can't Get Menu Item bigbasket Price at AutoComplete Menu Adapter ",Toast.LENGTH_LONG).show();
                ...
                //   int last_index =  (AddBigBasketOrder.cart_Item_List.size()-1);
                //  AddBigBasketOrder.cart_Item_List.set(last_index,modal_newOrderItems);
    ...
    private void addItemIntheCart(Modal_NewOrderItems newItem_newOrdersPojoClass, String itemWeight, String itemUniquecode) {
        ...
        if (IsItemAlreadyAddedinCart) {
            Modal_NewOrderItems modal_newOrderItems = AddBigBasketOrder.cartItem_hashmap.get(itemUniquecode);
            ...
            AddBigBasketOrder.cartItem_hashmap.put(itemUniquecode, modal_newOrderItems);
            ...
            AddBigBasketOrder.cart_Item_List.add(itemUniquecode);
            AddBigBasketOrder.cartItem_hashmap.put(itemUniquecode, newItem_newOrdersPojoClass);
