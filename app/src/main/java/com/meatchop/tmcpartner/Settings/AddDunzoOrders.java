...
public class AddDunzoOrders extends AppCompatActivity {
    ...
    static Adapter_AddDunzoOrdersRecyclerview adapter_addDunzoOrdersRecyclerview;
    ...
    EditText dunzoOrdersCustomermobileno;
    ...
    private static final String ACTION_USB_PERMISSION = "com.android.example.USB_PERMISSION.AddDunzoOrders";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dunzo_orders);
        loadingpanelmask = findViewById(R.id.loadingpanelmask);
        loadingPanel = findViewById(R.id.loadingPanel);
        new NukeSSLCerts();
        NukeSSLCerts.nuke();
        procced_to_pay_widget = findViewById(R.id.procced_to_pay_widget);
        dunzoOrdersCustomermobileno  = findViewById(R.id.editTextPhone);
        ...
        procced_to_pay_widget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (dunzoOrdersCustomermobileno.getText().toString().length() == 10) {
                    ...
                    if (cart_Item_List.size() > 0 && cartItem_hashmap.size() > 0) {
                        ...
                        if ((!total_item_Rs_text_widget.getText().toString().equals("0")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals("0")) &&(!total_item_Rs_text_widget.getText().toString().equals("0.0")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals("0.0"))&&(!total_item_Rs_text_widget.getText().toString().equals("0.00")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals("0.00"))&&(!total_item_Rs_text_widget.getText().toString().equals("")) && (!total_Rs_to_Pay_text_widget.getText().toString().equals(""))) {
                            ...
                            if (checkAllPriceperkgItemWeightWasEdited()){
                                ...
                                usermobileNo = "+91"+dunzoOrdersCustomermobileno.getText().toString();

                                PlaceOrdersinDatabaseaAndPrintRecipt(Constants.DUNZOORDER_PAYMENTMODE, sTime, Currenttime, cart_Item_List);
                            }
                            else {
                                showProgressBar(false);

                                AlertDialogClass.showDialog(AddDunzoOrders.this, R.string.Orders_weight_Cant_be_leave_unedited);
                            ...
                            AlertDialogClass.showDialog(AddDunzoOrders.this, R.string.Cant_place_order);

                        }
                    } else {
                        AlertDialogClass.showDialog(AddDunzoOrders.this, R.string.Cart_is_empty);

                    }

                } else {
                    AlertDialogClass.showDialog(AddDunzoOrders.this, R.string.Enter_the_mobile_no_text);
    ...
    protected void onStart() {
        ...
        dunzoOrdersCustomermobileno.setText("");
    ...
    void CallAdapter() {
        ...
        //  adapter_cartItem_listview= new Adapter_CartItem_Listview(mContext,cartItem_hashmap, MenuItems,AddDunzoOrders.this);
        //  listview.setAdapter(adapter_cartItem_listview);
        adapter_addDunzoOrdersRecyclerview = new Adapter_AddDunzoOrdersRecyclerview(getApplicationContext(),cartItem_hashmap, MenuItem, AddDunzoOrders.this);
        adapter_addDunzoOrdersRecyclerview.setHandler(newHandler());
        recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        int last_index=AddDunzoOrders.cartItem_hashmap.size()-1;

        recyclerView.setAdapter(adapter_addDunzoOrdersRecyclerview);
    ...
    private void PlaceOrdersinDatabaseaAndPrintRecipt(String paymentMode, long sTime, String currenttime, List<String> cart_Item_list) {
        ...
        if (ispaymentMode_Clicked) {
            ...
            if(!isCustomerOrdersTableServiceCalled){
                try{
                    if(orderdetailsnewschema){
                        String customerMobileNo = dunzoOrdersCustomermobileno.getText().toString();
            ...
            if (!isOrderDetailsMethodCalled) {
                ...
                PlaceOrder_in_OrderDetails(cart_Item_List, paymentMode, sTime);
            }
    ...
    private void PlaceOrder_in_OrderDetails(List<String> cart_Item_List1, String Payment_mode, long sTime) {
        ...
        String tokenno = "";
        String userid = "";
        String ordertype = Constants.DunzoOrder;
        String deliverytype ="";
        String slotdate = "";
        ...
        String UserMobile = "+91" + dunzoOrdersCustomermobileno.getText().toString();
        String vendorkey = sh.getString("VendorKey", "tmc");
        String vendorName = sh.getString("VendorName", "tmc");
...
//////////////////////
            if(isinventorycheck) {
                ...
                if (modal_newOrderItems.getPricetypeforpos().toUpperCase().equals(Constants.TMCPRICE)) {
                    ...
                    try {
                        grossWeightWithQuantity_double = grossweightingrams_double1 * quantityDouble;
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                        ...
                        try {
                            if(printerType_sharedPreference.equals(Constants.USB_PrinterType)){
                                ...
                                if(i != -1){
                                    ...
                                    new TMCAlertDialogClass(AddDunzoOrders.this, R.string.app_name, R.string.OrderPlaced_Printer_is_Disconnected,
                                ...
                                new TMCAlertDialogClass(AddDunzoOrders.this, R.string.app_name, R.string.OrderPlaced_Printer_is_Disconnected,
                                        ...
                                        new TMCAlertDialogClass.AlertListener() {
                                            ...
                                            public void onYes() {
                                                ...
                                                totalAmounttopay=0;
                                                finalamounttoPay=0;
                                                showProgressBar(false); //Toast.makeText(AddDunzoOrders.this,"Please Generate Token Number Again",Toast.LENGTH_SHORT).show();
                                            }
    ...
    private void PrintReciptForNewItemUsingUSBPrinter(String userMobile, String tokenno, String itemTotalwithoutGst, String taxAmount, String payableAmount, String orderid, List<String> cart_item_list, HashMap<String, Modal_NewOrderItems> cartItem_hashmap, String payment_mode, String finalCouponDiscountAmount, String ordertype) {
        ...
        UsbConnection usbConnection = UsbPrintersConnectionsLocal.selectFirstConnected(AddDunzoOrders.this);
        UsbManager usbManager = (UsbManager) AddDunzoOrders.this.getSystemService(Context.USB_SERVICE);

        if (usbConnection == null || usbManager == null) {
            showProgressBar(false);

          /*  new AlertDialog.Builder(AddDunzoOrders.this)
           ...
           */
            ...
            new TMCAlertDialogClass(AddDunzoOrders.this, R.string.app_name, R.string.ReConnect_Instruction,
                    ...
                    new TMCAlertDialogClass.AlertListener() {
                        ...
                        @Override
                        public void onNo() {
                            AddDunzoOrders.cart_Item_List.clear();
                            AddDunzoOrders.cartItem_hashmap.clear();
                            cart_item_list.clear();
                            cartItem_hashmap.clear();
                            StockBalanceChangedForThisItemList.clear();
                            ...
                            finaltoPayAmount = "0";
                            //  discount_rs_text_widget.setText(discountAmount);
                            OrderTypefromSpinner = "DUNZO Order";
                            //   orderTypeSpinner.setSelection(0);
                            total_item_Rs_text_widget.setText(String.valueOf(old_total_Amount));
                            taxes_and_Charges_rs_text_widget.setText(String.valueOf((old_taxes_and_charges_Amount)));
                            total_Rs_to_Pay_text_widget.setText(String.valueOf(new_to_pay_Amount));
        ...
        filter.addCategory("Add Dunzo Orders");
    ...
    private final BroadcastReceiver usbReceiver_newItem = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_USB_PERMISSION.equals(action)) {
                synchronized (AddDunzoOrders.this) {
                    UsbManager usbManager = (UsbManager) AddDunzoOrders.this.getSystemService(Context.USB_SERVICE);
                            ...
                            new AsyncUsbEscPosPrint(
                                ...
                                public void onSuccess(AsyncEscPosPrinter asyncEscPosPrinter) {
                                    ...
                                    if (!isPrintedSecondTime) {
                                        ...
                                        new TMCAlertDialogClass(AddDunzoOrders.this, R.string.app_name, R.string.RePrint_Instruction,
 ...
 */
        //    text_to_Print = text_to_Print + "[L]" + payableAmount + " \n";
            ...
            Toast.makeText(AddDunzoOrders.this, "Size of Cart is not matched", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadMenuAvailabilityStatusTranscationinDB(String userPhoneNumber, String menuItemName, boolean availability, String menuItemSubCtgykey, String vendorkey, String dateandtime, String menuItemKey, String message, String menuItemStockAvlDetailskey, boolean allowNegative, String itemStockAvlDetailskey) {
        ...
        // Make the request
        Volley.newRequestQueue(AddDunzoOrders.this).add(jsonObjectRequest);
      ...
      */
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.api_getListofStockOutGoingDetailsForStockIncmgKey + stockIncomingKey_avlDetails, null,
                        ...
                        public void onErrorResponse(@NonNull VolleyError error) {
                            ...
                            Toast.makeText(AddDunzoOrders.this, "Error in General App Data code :  " + errorCode, Toast.LENGTH_LONG).show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.api_addEntry_StockTransactionHistory
            ...
            public void onResponse(@NonNull JSONObject response) {
                ...
                try {
                    ...
                    // showProgressBar(false);
                    Toast.makeText(AddDunzoOrders.this,"Failed to Add Data in Stock Outgoing table",Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
        ...
        if(changeItemAvailability){
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.api_updateMenuItemDetails,
                ...
                public void onErrorResponse(@NonNull VolleyError error) {
                    ...
                    //Log.d(Constants.TAG, "Error: " + error.toString());
                    showProgressBar(false);
                    Toast.makeText(AddDunzoOrders.this,"Failed to change express delivery slot status inDelivery slot details",Toast.LENGTH_LONG).show();
 ...
 */
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, api_Update_MenuItemStockAvlDetails
            ...
            public void onResponse(@NonNull JSONObject response) {
                ...
                try {
                    ...
                    // showProgressBar(false);
                    Toast.makeText(AddDunzoOrders.this,"Failed to change express delivery slot status in Delivery slots",Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
    ...
    private void savedMenuIteminSharedPrefrences(List<Modal_MenuItem_Settings> menuItem, int iterator_menuitemStockAvlDetails) {
        ...
        try {
            adapter_addDunzoOrdersRecyclerview.notifyDataSetChanged();
            adapter_addDunzoOrdersRecyclerview.notify();
            adapter_addDunzoOrdersRecyclerview.notifyItemChanged(iterator_menuitemStockAvlDetails);

            adapter_addDunzoOrdersRecyclerview.notifyAll();
        }
        catch (Exception e){
            e.printStackTrace();
        }
    ...
    private void PlaceOrder_in_OrderTrackingDetails(long sTime,String Currenttiime) {
        ...
        try {
            ...
            orderTrackingTablejsonObject.put("usermobileno","+91" + dunzoOrdersCustomermobileno.getText().toString());
