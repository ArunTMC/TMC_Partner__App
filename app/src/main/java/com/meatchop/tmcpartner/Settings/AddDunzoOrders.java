...
public class AddDunzoOrders extends AppCompatActivity {
    ...
    static Adapter_AddDunzoOrdersRecyclerview adapter_addSwiggyOrdersRecyclerview;
    ...
    void CallAdapter() {
        ...
        adapter_addSwiggyOrdersRecyclerview = new Adapter_AddDunzoOrdersRecyclerview(getApplicationContext(),cartItem_hashmap, MenuItem, AddDunzoOrders.this);
