    ...
    private void ChangeAvailability_subctgywise_InMenuItemDB(boolean isChecked) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.api_Update_ChangeMenuItemAvailability_SubCtgywise,
            ...
            public void onResponse(@NonNull JSONObject response) {
                ...
                uploadMenuAvailabilityStatusTranscationinDB(UserPhoneNumber,SubCtgyName, Boolean.parseBoolean(checked_or_not),SubCtgyKey,vendorkey,dateandtime,SubCtgyKey,message, "", false, "");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.api_updateMenuItemDetails,
            ...
            public void onResponse(@NonNull JSONObject response) {
                ...
                if(menuItemStockAvlDetailskey.equals("") || menuItemStockAvlDetailskey.equals("null") || menuItemStockAvlDetailskey.equals(null) || menuItemStockAvlDetailskey.equals("NULL")) {
                    ...
                    uploadMenuAvailabilityStatusTranscationinDB(UserPhoneNumber, menuItemName, Boolean.parseBoolean(availability), menuItemSubCtgykey, vendorkey, dateandtime, menuItemKey, message, "", false, "");
                }
    ...
    private void getMenuItemsbasedOnSubCtgy(String subCtgykey) {
        ...
        for(int i=0;i<MenuItem.size();i++){
            ...
            if(menuSubCtgy.equals(subCtgykey)) {
                ...
                if(modal_menuItemSettings.getInventorydetails().toString().equals("") || modal_menuItemSettings.getInventorydetails().toString().equals("nil")   ) {
               ...
               /* if(modal_menuItemSettings.getInventorydetails().toString().equals("")) {
                    ...
                    try {
                        jsonArray = new JSONArray(String.valueOf(modal_menuItemSettings.getInventorydetails().toString()));
                    ...
                    for (; jsonArrayIterator < (jsonArrayCount); jsonArrayIterator++) {
                        ...
                        try {
                            String menuItemKeyFromInventoryDetails,itemAvail_AvlDetails_InventoryJson="",allowNegativeStock ="",itemAvailDetails_InventoryJson = "";
                            ...
                            for (int iterator_menuitemStockAvlDetails = 0; iterator_menuitemStockAvlDetails < MenuItem.size(); iterator_menuitemStockAvlDetails++) {
                                ...
                                Modal_MenuItem_Settings modal_menuItem_settings = MenuItem.get(iterator_menuitemStockAvlDetails);

                                String menuItemKeyFromMenuAvlDetails = String.valueOf(modal_menuItem_settings.getKey());

                                if (menuItemKeyFromInventoryDetails.equals(menuItemKeyFromMenuAvlDetails)) {


                                    try {
                                        itemAvail_AvlDetails_InventoryJson = String.valueOf(modal_menuItem_settings.getItemavailability_AvlDetails().toString());
                                    } catch (Exception e) {
                                        itemAvail_AvlDetails_InventoryJson = "FALSE";
                                        e.printStackTrace();
                                    }

                                    try {
                                        allowNegativeStock = String.valueOf(modal_menuItem_settings.getAllownegativestock().toString());
                                    } catch (Exception e) {
                                        allowNegativeStock = "FALSE";
                                        e.printStackTrace();
                                    }
                                    try {
                                        itemAvailDetails_InventoryJson = String.valueOf(modal_menuItem_settings.getItemavailability().toString());
                                    } catch (Exception e) {
                                        itemAvailDetails_InventoryJson = "FALSE";
                                        e.printStackTrace();
                                    }

                                    selected_CtgyItems.itemavailability_AvlDetails = String.valueOf(itemAvail_AvlDetails_InventoryJson );
                                    selected_CtgyItems.allownegativestock = String.valueOf(allowNegativeStock);
                                    selected_CtgyItems.itemavailability = String.valueOf(itemAvailDetails_InventoryJson);
                ...
                */
                ...
                adapter_Change_menutem_availabilityWithAllowNegativeStock_settings = new Adapter_ChangeMenutem_AvailabilityWithAllowNegativeStock_settings(ChangeMenuItemStatus_AllowNegativeStock_Settings.this, displaying_menuItems, ChangeMenuItemStatus_AllowNegativeStock_Settings.this);
                ...
                if(message.toUpperCase().equals("SUCCESS")){
                    for (int i = 0; i < MenuItem.size(); i++) {
                        ...
                        if((!menuItemStockAvlDetailskey.equals(null)) && (!menuItemStockAvlDetailskey.equals("null")) ) {
                            uploadMenuAvailabilityStatusTranscationinDB(UserPhoneNumber, menuItemname, itemAvailability, tmcsubCtgykey, vendorkey, dateandtime, menuItemkey, message, menuItemStockAvlDetailskey, allowNegative, MenuItemName);
                        }
                Adjusting_Widgets_Visibility(false);
            }
        }, new Response.ErrorListener() {
